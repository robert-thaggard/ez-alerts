<div class="wrap">
    ...
    <form method="post">
        <?php wp_nonce_field('ez_ms_alerts_create_alert'); ?>
        <table class="form-table" style="margin-bottom: 15px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input class="<?php echo isset($validation_errors) && $validation_errors === true && $_POST['alert_title'] == '' ? 'ez_ms_alerts_error' : ''?>" type="text" name="alert_title" id="alert_title" size=60 value="<?php echo ez_ms_alerts\populate_field('alert_title', $_POST); ?>">
                    </td>
                </tr>
                <!-- Alert CSS -->
                <tr>
                    ...
                    <td>
                        <input type="text" name="alert_css" id="alert_css" size=60 value="<?php echo ez_ms_alerts\populate_field('alert_css', $_POST); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="alert_start" id="alert_start" value="<?php echo ez_ms_alerts\populate_field('alert_start', $_POST); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="alert_end" id="alert_end" value="<?php echo ez_ms_alerts\populate_field('alert_end', $_POST); ?>">
                    </td>
                </tr>
            </tbody>
        </table>
        <?php
          ...
          wp_editor(\ez_ms_alerts\populate_field('alert_message', $_POST, true), 'alert_message', array('editor_class' => $error_class));
        ?>
        <p class="submit">
            <input name="ez_ms_alerts_create" id="ez_ms_alerts_create" class="button button-primary" value="Create Alert" type="submit">
        </p>
    </form>
</div>
